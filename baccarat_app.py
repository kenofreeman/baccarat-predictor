...
# Pied de page
st.markdown("---")
st.markdown("**Baccarat Predictor** - Prédictions générées le " + datetime.now().strftime("%d/%m/%Y %H:%M"))
st.markdown("> *Note: Les prédictions sont basées sur des modèles statistiques et ne garantissent pas les résultats réels*")
